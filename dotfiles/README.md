...
- [ ] Scripting (.sh files):
    ...
    - [x] Newsboat open, load, and mpv fetch for YT video (maybe 2 or 3 scripts).
...
- [ ] Virtual Machine to Play Zombies? KVM, QEMU, VirtManager
- [ ] Keybindings for Grim
- [ ] new Bucket Logo - pngs and ascii too
- [ ] configure neomutt
- [ ] auto-mount the HDDs and SSD on startup
...
https://www.reddit.com/r/Proxmox/comments/r1e52g/using_libvfio_to_play_warzone_in_a_windows/
